...
#ifndef __RESULTADOCOMPARACION_
#define __RESULTADOCOMPARACION_
...
/* Tipo de Informacion que esta contenida en los Nodos de la
   Lista, identificada como equipo. */
typedef Equipo equipo;

/* Tipo de Estructura de los Nodos de la Lista. */
struct NodoLista {
    equipo dato; // dato almacenado
    NodoLista* sgte; // puntero al siguienteEquipo
};

/* Tipo de Puntero a los Nodos de la Lista, el cual se usa para recorrer
   la Lista y acceder a sus Datos. */
typedef NodoLista* PtrNodoListaEquipo;


/* Tipo de Estructura de la Lista */
struct ListaEquipo{
    PtrNodoListaEquipo primero;      // puntero al primer nodo de la lista
};
...
*/
bool listaVacia(ListaEquipo &lista);
...
/*
  ...
  lista : lista sobre la cual se invoca la primitiva.
  prtNodo : puntero al nodo a partir del cual se requiere el siguienteEquipo.
  return puntero al nodo siguienteEquipo.
*/
...
*/
PtrNodoListaEquipo anterior(ListaEquipo &lista, PtrNodoListaEquipo ptrNodo);
...
*/
PtrNodoListaEquipo ultimo(ListaEquipo &lista);
...
/*
  ...
  lista : lista sobre la cual se invoca la primitiva.
*/
int longitud(ListaEquipo &lista);
