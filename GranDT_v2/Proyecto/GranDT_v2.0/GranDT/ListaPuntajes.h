 ...
 * Archivo : ListaPuntajes.h
 * Versión : 1.1
 */



#ifndef __LISTAPUNTAJES_H__
#define __LISTAPUNTAJES_H__
#include "Puntajes.h"
#ifndef NULL
#define NULL      0
#endif
...
enum ResultadoComparacionPuntajes {
  MAYORPUNTAJE,
  IGUALPUNTAJE,
  MENORPUNTAJE
};
...
//typedef Puntajes Puntajes;

/* Tipo de Estructura de los Nodos de la Lista. */
struct NodoListaPuntajes {
    Puntajes dato; // dato almacenado
    NodoListaPuntajes* sgte; // puntero al siguiente
};

/* Tipo de Puntero a los Nodos de la Lista, el cual se usa para recorrer
   la Lista y acceder a sus Datos. */
typedef NodoListaPuntajes* PtrNodoListaPuntajes;


/* Tipo de Estructura de la Lista */
struct ListaPuntajes{
    PtrNodoListaPuntajes primero;      // puntero al primer nodo de la lista
};
...
/*
  ...
  return representación del finJugador de la lista.
*/
...
*/
PtrNodoListaPuntajes localizarDato(ListaPuntajes &lista , Puntajes puntajes);
