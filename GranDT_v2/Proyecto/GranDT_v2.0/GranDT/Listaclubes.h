...
#ifndef __LISTACLUBES_H__
#define __LISTACLUBES_H__
#include "Club.h"
#ifndef NULL
#define NULL      0
#endif
...
enum ResultadoComparacionClubes {
  MAYORCLUB,
  IGUALCLUB,
  MENORCLUB
};
...
struct NodoListaClubes {
    Clubes clubes; // dato almacenado
    NodoListaClubes* sgte; // puntero al siguiente
};

/* Tipo de Puntero a los Nodos de la Lista, el cual se usa para recorrer
   la Lista y acceder a sus Datos. */
typedef NodoListaClubes* PtrNodoListaClubes;


/* Tipo de Estructura de la Lista */
struct ListaClubes{
    PtrNodoListaClubes primero;      // puntero al primer nodo de la lista
};
